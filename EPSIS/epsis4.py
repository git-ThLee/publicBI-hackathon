...
if __name__ == '__main__':
    ...
    while 1 :
        ...
        time.sleep(0.2)
        # 다음 월 버튼 
        driver.find_element(By.XPATH, r'//*[@id="ui-datepicker-div"]/div/a[2]/span').click()
        time.sleep(0.2)
        # 현재 년도 찾기
        select_element = driver.find_element(By.XPATH, '//*[@id="ui-datepicker-div"]/div/div/select')
        selected_value = select_element.get_attribute("value")
        if int(selected_value) == end_year:
            break
